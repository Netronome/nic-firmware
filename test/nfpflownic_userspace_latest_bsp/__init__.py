...
class Project(netro.testinfra.Project):
    ...
    summary = "Tests for NFPFlowNIC with user space firmware loading and " \
              "the LTEAST BSP"
    _groups = collections.OrderedDict((("setup_tip_bsp",
                                        NFPFlowNICSetup_tip_bsp),
                                       ("unit", NFPFlowNICUnit_userspace),
                                       ("perf",
