...
/* Test __pv_lso_fixup() on an IPv4 pkt, not last segment, with LSO disabled */
...
// TX_LSO = 0, lso seq cnt = 2, mss  = 1
alu[value, --, B, 0, <<BF_L(NFD_IN_FLAGS_TX_LSO_fld)]
...
alu[expected[3], PROTO_UNKNOWN, OR, value, <<8]

#define_eval _PV_OUTER_L3_OFFSET (0)
#define_eval _PV_OUTER_L4_OFFSET (0)
