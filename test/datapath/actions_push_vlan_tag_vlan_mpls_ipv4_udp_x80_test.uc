...
mem[read32, $__pv_pkt_data[0], pkt_addr, 0, 6], ctx_swap[sig_rd]
test_assert_equal($__pv_pkt_data[0], 0x22334455)
test_assert_equal($__pv_pkt_data[1], 0x66771122)
test_assert_equal($__pv_pkt_data[2], 0x33445566)
test_assert_equal($__pv_pkt_data[3], 0x81000aaa)
ld_field_w_clr[etype, 0011, $__pv_pkt_data[4], >>16]
test_assert_equal(etype, 0x8100)
ld_field_w_clr[etype, 0011, $__pv_pkt_data[5], >>16]
test_assert_equal(etype, 0x8847)
