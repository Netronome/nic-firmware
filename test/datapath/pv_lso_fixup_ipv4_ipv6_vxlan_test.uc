...
move(pkt_vec[3], PROTO_IPV4_UDP_VXLAN_IPV6_TCP)
...
move(expected[3], PROTO_IPV4_UDP_VXLAN_IPV6_TCP)
...
move(expected[0],  0x45aa0092) // Total Length = PV Packet Length(0xa0) - 14
...
move(expected[6],  0x007e0000) // Length = PV Packet Length(0xa0) - (14 + 20)
...
move(expected[1],  0x003806ff) // Total Length = PV Packet Length(0xa0) - (14+20+8+8+14+40)
