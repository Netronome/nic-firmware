...
#include "pkt_ipv6_ipv4_lso_vxlan_tcp_x80.uc"
...
#define_eval _PV_INNER_L4_OFFSET (14 + 40 + 8 + 8 + 14 + 20)
...
move(pkt_vec[3], PROTO_IPV6_UDP_VXLAN_IPV4_TCP)
...
move(expected[3], PROTO_IPV6_UDP_VXLAN_IPV4_TCP)
move(expected[4], 0x0)
...
move(expected[1],  0x006a11ff) // Total Length = PV Packet Length(0xa0) - (14 + 40)
...
move(expected[11], 0x006a0000) // Length = PV Packet Length(0xa0) - (14 + 40)
...
move(expected[0],  0x4555004c) // Total Length = PV Packet Length(0xa0) - (14+40+8+8+14)
