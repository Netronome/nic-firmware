...
from reboot_hosts import RebootHosts
from install_bsp_sdk import InstallBSPSDK
...
class NFPFlowNICSetup(_NFPFlowNICSetup):
    ...
    def __init__(self, name, cfg=None,
        ...
        self._tests[tn] = InstallBSPSDK(self, group=self, name=tn,
                                        summary="Install stable known BSP for "
                                                "nfpflownic tests.")
