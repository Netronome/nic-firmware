...
#define NBI_DMA_BP7_BLQ_TARGET   0,0
    ...
    #define NBI0_DMA_BPE_CONFIG_ME_ISLAND0   1,128,11
    #define NBI0_DMA_BPE_CONFIG_ME_ISLAND1   1,128,11
    #define NBI0_DMA_BPE_CONFIG_ME_ISLAND2   1,128,11
    #define PCI0_DMA_BPE_CONFIG_ME_ISLAND0  1,128,11
    #define PCI0_DMA_BPE_CONFIG_ME_ISLAND1  1,128,11
    #define PCI0_DMA_BPE_CONFIG_ME_ISLAND2  1,128,11
    #define MEI_DMA_BPE_CONFIG_ME_ISLAND0   1,128,11
    #define MEI_DMA_BPE_CONFIG_ME_ISLAND1   1,128,11
    #define MEI_DMA_BPE_CONFIG_ME_ISLAND2   1,128,11
#else
