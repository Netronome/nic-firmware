...
#macro gro_config_block(BLOCKNUM, CALLER)
        ...
        gro_declare_ctx(BLOCKNUM, CALLER, 0, GRO_ISL, 24, 16384, 2048)

        gro_declare_ctx(BLOCKNUM, CALLER, 1, GRO_ISL, 24, 16384, 2048)

        gro_declare_ctx(BLOCKNUM, CALLER, 2, GRO_ISL, 24, 16384, 2048)

        gro_declare_ctx(BLOCKNUM, CALLER, 3, GRO_ISL, 24, 16384, 2048)

        gro_declare_ctx(BLOCKNUM, CALLER, 4, GRO_ISL, 24, 16384, 2048)

        gro_declare_ctx(BLOCKNUM, CALLER, 5, GRO_ISL, 24, 16384, 2048)
